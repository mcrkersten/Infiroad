...
public class Rumbler : MonoBehaviour
{
    ...
    private RumblePattern activeRumbelPattern;
    ...
    {
        activeRumbelPattern = RumblePattern.Constant;
        lowA = low;
        highA = high;
    ...
    {
        activeRumbelPattern = RumblePattern.Pulse;
        lowA = low;
        highA = high;
    ...
    {
        activeRumbelPattern = RumblePattern.Linear;
        lowA = lowStart;
        highA = highStart;
